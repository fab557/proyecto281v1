...
<head>
    ...
    <title><?= esc($title ?? 'Administrador') ?></title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('administrador/ver_usuarios') ?>"><i class="fas fa-users"></i> Ver Usuarios</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('administrador/anadir_almacen') ?>"><i class="fas fa-plus"></i> Añadir Almacén</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('administrador/ver_almacen') ?>"><i class="fas fa-archive"></i> Ver Almacén</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('administrador/ver_categorias') ?>"><i class="fas fa-list-alt"></i> Ver Categorías</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('administrador/ver_productos') ?>"><i class="fas fa-box"></i> Ver Productos</a>
            </li>
        </ul>
    </div>
