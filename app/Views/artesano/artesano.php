...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('artesano/ver_productos') ?>"><i class="fas fa-box-open"></i> Ver Productos</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('artesano/anadir_productos') ?>"><i class="fas fa-plus"></i> Añadir Productos</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('artesano/anadir_almacen') ?>"><i class="fas fa-plus"></i> Añadir Almacén</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('artesano/anadir_categoria') ?>"><i class="fas fa-plus"></i> Añadir Categoría</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('artesano/categoria') ?>"><i class="fas fa-tags"></i> Categoría</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('artesano/almacen') ?>"><i class="fas fa-warehouse"></i> Almacén</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('artesano/ver_ventas') ?>"><i class="fas fa-shopping-cart"></i> Ver Ventas</a>
            </li>
        </ul>
    </div>
